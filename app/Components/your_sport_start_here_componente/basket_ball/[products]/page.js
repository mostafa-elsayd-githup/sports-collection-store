...
import NavAction from "../../../../Navbar/navbar";
...
async function getProduct(id) {
  console.log(id)
 try{
 const res = await fetch(`http://localhost:1200/your_sport_start_hear_backitball/${id}`, {
    next: { revalidate: 600 }, // تحديث البيانات كل دقيقة
  });
