  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative" }}>
        <Link href={`/Components/Collection/man_colliction/mans_section/t_shirt${productItem.id}`}>
          <Card.Img
            name="image"
            variant="top"
            src={currentImg}
      ...
      <Card.Body>
        ...
        <p className={styles.category}>{productItem.category}</p>
          ...
          {productItem.url.length ? <p className={styles.colors}> `Colors: ${productItem.url.length}`   </p> : null}
     
        <p className={styles.made}>
          {productItem.made ? productItem.made : null}
        </p>
      </Card.Body>
    </Card>
  );
