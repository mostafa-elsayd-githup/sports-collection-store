  ...
  return (
    ...
    >
        ...
        >
          ...
          <button
            ...
            onMouseDown={() => {
              ...
              if (!pending) {
                Router.push(`/Components/Collection/man_colliction/mans_section/hoody/${productItem.id}`);
              }
            }}
            style={{
              background: "none",
        ...
        <div className={styles.small_products}>
          {productItem.url.map((style) => (
            <div key={style.id} className={styles.small_img}>
              <Link href={`/Components/Collection/man_colliction/mans_section/hoody/${style.id}`}>
                <Card.Img
                  variant="top"
                  src={style.img_url}
      ...
      <Card.Body>
        ...
        <Link href={`/Components/Collection/man_colliction/mans_section/hoody/${productItem.id}`}>
